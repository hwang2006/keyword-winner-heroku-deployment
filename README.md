...
## Reference
Here is the [keyword-winner app deployed on Heroku](https://keyword-winner-39a53d276a1b.herokuapp.com/) that enables you to compare the Google search result numbers for two keywords. You can simply enter two keywords (e.g., apple vs. banana or 사과 vs. 바나나) as inputs and see the comparison of their respective search result numbers:
